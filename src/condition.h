...
const std::unordered_set<std::string> complex_conds = { {
        ...
        "npc_has_morale", "u_is_on_terrain", "npc_is_on_terrain", "u_is_in_field", "npc_is_in_field", "compare_int", "compare_string", "u_reached_any_threshold", "roll_contested"
    }
};
} // namespace dialogue_data
...
struct conditional_t {
    ...
    public:
        ...
        void set_reached_any_threshold(const JsonObject& jo, const std::string& member, bool is_npc = false); 
