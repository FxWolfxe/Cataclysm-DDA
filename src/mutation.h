...
struct mutation_branch {
        ...
        std::optional<float> movecost_weilded_modifier = std::nullopt; 
        float scent_modifier = 1.0f;
        std::optional<int> scent_intensity;
        std::optional<int> scent_mask;

        std::optional<float> movecost_barefoot_modifier = std::nullopt; 
        ...
        std::optional<float> climbing_difficulty_modifier = std::nullopt; 
    ...
    private:
        ...
        std::optional<translation> raw_transformation_text; 
    public:
        ...
        std::optional<translation> get_random_gain_snippet() const;
         ...
         */
        std::optional<std::string> transformation_text() const;
